...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal DML.Cliente Consultar(long Id)
        {
            ...
            param.Add(new System.Data.SqlClient.SqlParameter("IDCLIENTE", Id));
            DataSet dsBen = base.Consultar("FI_SP_ConsBeneficiario", param);

            foreach(DataRow dr in dsBen.Tables[0].Rows)
            {
                DML.Beneficiario ben = new Beneficiario();
                ben.Id = dr.Field<long>("ID");
                ben.IdCliente = dr.Field<long>("IDCLIENTE");
                ben.Nome = dr.Field<string>("NOME");
                ben.CPF = dr.Field<string>("CPF");

                cli.FirstOrDefault().Beneficiarios.Add(ben);
            }
        ...
        internal void Alterar(DML.Cliente cliente)
        {
            ...
            foreach (var beneficiario in cliente.Beneficiarios)
            {
                ...
                {
                    List<System.Data.SqlClient.SqlParameter> param = new List<System.Data.SqlClient.SqlParameter>();
                    param.Add(new System.Data.SqlClient.SqlParameter("NOME", beneficiario.Nome));
                    param.Add(new System.Data.SqlClient.SqlParameter("ID", beneficiario.Id));
                    param.Add(new System.Data.SqlClient.SqlParameter("CPF", beneficiario.CPF));
                    base.Executar("FI_SP_AltBenef", param);
                }
            }
        }
